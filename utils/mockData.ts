...
export const PRODUCTS: Product[] = [
  // --- CLOTHING (8) ---
  {
    ...
    price: 850000,
    description: "Áo sơ mi trắng tối giản với chất liệu cotton cao cấp, thoáng mát và đứng form.",
  ...
  },
  {
    ...
    price: 450000,
    description: "Áo thun đen basic không thể thiếu trong tủ đồ, mềm mại và bền bỉ.",
  ...
  },
  {
    ...
    price: 1250000,
    description: "Quần tây chất liệu linen sang trọng, phù hợp cho cả đi làm và đi chơi.",
  ...
  },
  {
    ...
    price: 2450000,
    description: "Áo Blazer dạ oversized tạo điểm nhấn sang trọng cho mọi set đồ.",
  ...
  },
  {
    ...
    price: 3200000,
    description: "Váy lụa dạ hội với đường cắt xẻ tinh tế, tôn vinh nét quyến rũ.",
  ...
  // --- SHOES (8) ---
  {
    ...
    images: ["https://images.unsplash.com/photo-1533274109224-21805a231df3?auto=format&fit=crop&q=80&w=800"],
    category: "Shoes",
    sizes: ["39", "40", "41", "42"],
    colors: ["Black", "Brown"],
  },
  {
    ...
    price: 1450000,
    description: "Giày sneaker trắng phong cách tối giản, dễ dàng phối hợp mọi trang phục.",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1520639889456-1215b0271701?auto=format&fit=crop&q=80&w=800"],
    category: "Shoes",
    sizes: ["40", "41", "42", "43"],
    colors: ["Black", "Tan"],
  },
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1603191659812-ee978ecef7ca?auto=format&fit=crop&q=80&w=800"],
    category: "Shoes",
    sizes: ["36", "37", "38", "39"],
  ...
  // --- HATS (8) ---
  {
    ...
    price: 350000,
    description: "Mũ lưỡi trai thêu logo Aura Studio tinh tế, phong cách streetwear hiện đại.",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1576871337622-98d48d7ca53e?auto=format&fit=crop&q=80&w=800"],
    category: "Hats",
    sizes: ["One Size"],
    colors: ["Grey", "Cream"],
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1521369909029-2afed882ba91?auto=format&fit=crop&q=80&w=800"],
    category: "Hats",
    sizes: ["One Size"],
    colors: ["Natural"],
  },
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1582200257018-0a068a0a8661?auto=format&fit=crop&q=80&w=800"],
    category: "Hats",
    sizes: ["One Size"],
    colors: ["Black", "Red"],
  },
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1575428652377-a2d80e2277fc?auto=format&fit=crop&q=80&w=800"],
    category: "Hats",
    sizes: ["One Size"],
  ...
  // --- ACCESSORIES (8) ---
  {
    ...
    images: ["https://images.unsplash.com/photo-1624222247344-550fb8ecf742?auto=format&fit=crop&q=80&w=800"],
  ...
  },
  {
    ...
    name: "Aura Tote Bag",
    price: 350000,
    description: "Túi vải tote chất liệu canvas dày dặn, thân thiện môi trường.",
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1511499767390-a7335958beb7?auto=format&fit=crop&q=80&w=800"],
    category: "Accessories",
    sizes: ["One Size"],
