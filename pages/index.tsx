...
export default function Home() {
  ...
  const categories = [
    ...
    },
    {
      ...
      link: "/shop?category=Hats",
    },
    {
      name: "Phụ kiện",
      image:
        "https://images.unsplash.com/photo-1511405946472-a37e3b5ccd47?auto=format&fit=crop&q=80&w=800",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      content:
        "Chất liệu vải cực kỳ thoáng mát và đứng form. Đây là lần thứ 3 tôi mua áo sơ mi ở Aura Studio.",
    },
    {
      name: "Trần Minh Quân",
      rating: 5,
      content:
        "Dịch vụ khách hàng tuyệt vời. Đóng gói hộp rất sang trọng, mở ra còn có mùi thơm nhẹ.",
    },
    {
      name: "Lê Ngọc Hân",
      rating: 5,
      content:
        "Thực sự yêu thích phong cách The Art of Less của shop. Đồ basic nhưng chất lượng.",
    },
  ];
      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {categories.map((cat, idx) => (
              <Link
                href={cat.link}
                key={idx}
                className="relative aspect-[3/4] md:aspect-square group overflow-hidden block rounded-2xl"
              >
                <img
                  src={cat.image}
                  alt={cat.name}
                ...
                <div className="absolute bottom-6 left-6 right-6 text-center text-white">
                  <h3 className="text-sm md:text-lg font-bold uppercase tracking-widest mb-1 group-hover:-translate-y-2 transition-transform duration-300">
                    {cat.name}
                  </h3>
        ...
        <section className="py-24 bg-aura-gray-light">
          <div className="container mx-auto px-4 md:px-8">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-xs font-bold uppercase tracking-[0.3em] text-aura-gray-dark mb-4">
                  Best Sellers
                </h2>
              ...
              <Link
                href="/shop"
                className="hidden md:block text-sm font-bold uppercase tracking-widest border-b-2 border-aura-black pb-1 hover:text-aura-gray-dark hover:border-aura-gray-dark transition-colors"
              >
                Xem tất cả
              </Link>
            </div>
              ...
              {PRODUCTS.slice(0, 4).map((product) => (
                <div key={product.id} className="group">
                  ...
                  <Link href={`/shop/${product.id}`}>
                    <h3 className="text-sm font-medium mb-2 group-hover:underline truncate">
                      {product.name}
                    </h3>
                  </Link>
        ...
        <section className="py-24 container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center bg-aura-black text-white overflow-hidden rounded-[2.5rem]">
            ...
            <div className="w-full md:w-1/2 p-12 md:p-24 text-center md:text-left flex flex-col justify-center">
              <h2 className="text-xs font-bold uppercase tracking-[0.4em] text-aura-accent mb-6">
                Mùa hè sôi động
              </h2>
              <p className="text-4xl md:text-5xl font-bold uppercase tracking-luxury mb-6 leading-tight">
                Giảm giá 20%
              </p>
              <p className="text-sm text-aura-gray-medium mb-12 leading-relaxed max-w-md mx-auto md:mx-0">
                Làm mới tủ đồ của bạn với bộ sưu tập những món đồ cơ bản nhưng
                không hề đơn điệu.
              </p>
              <div>
                <Link
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((review, idx) => (
                <div
                  key={idx}
                  className="bg-aura-gray-light p-8 md:p-12 flex flex-col items-center text-center rounded-[2rem]"
                >
                  <div className="flex space-x-1 mb-6">
                    {[...Array(review.rating)].map((_, i) => (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="w-5 h-5 text-aura-black"
                      >
                        <path
                          fillRule="evenodd"
        ...
        <section className="py-32 bg-aura-black text-center">
          <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-xs font-bold uppercase tracking-[0.4em] mb-12 text-aura-accent">
              Triết lý Aura
            </h2>
            <p className="text-2xl md:text-3xl font-light leading-relaxed italic text-white">
              &ldquo;Chúng tôi không chỉ bán quần áo. Chúng tôi kiến tạo một lối
              sống tối giản, nơi mỗi sản phẩm đều mang trong mình hơi thở của
              nghệ thuật và sự bền bỉ với thời gian.&rdquo;
            </p>
          </div>
        </section>
      </main>
