      ...
      <main className="flex-grow">
        ...
        <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white px-4">
            ...
            <p
              className="text-sm md:text-xl font-light tracking-widest uppercase animate-fade-in-up"
        ...
        <section className="py-24 md:py-32 container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
            <div className="w-full md:w-1/2">
              <FadeUpSection>
                <h2 className="text-xs font-bold uppercase tracking-[0.3em] text-aura-gray-dark mb-6">
                  Câu chuyện của chúng tôi
                </h2>
                <h3 className="text-3xl md:text-4xl font-medium mb-8 leading-tight">
                  Khởi nguồn từ sự tĩnh lặng giữa phố thị ồn ào.
                </h3>
                <div className="space-y-6 text-sm text-aura-gray-dark leading-relaxed">
                  <p>
                    Được thành lập vào năm 2025, Aura Studio không bắt đầu như
                    một thương hiệu thời trang chạy theo xu hướng. Chúng tôi bắt
                    đầu với một câu hỏi: &quot;Tại sao tủ quần áo của chúng ta
                    luôn đầy ắp nhưng lại chẳng có gì để mặc?&quot;.
                  </p>
                  <p>
                    Câu trả lời nằm ở sự dư thừa của những thiết kế chóng vánh
                    (fast-fashion). Aura Studio ra đời mang theo sứ mệnh tạo ra
                    một giải pháp thay thế: Những món đồ cơ bản (basics) được
                    nâng tầm bởi chất liệu hảo hạng, cắt may tinh tế và form
                    dáng trường tồn với thời gian.
                  </p>
                  <p>
                    Chúng tôi tin rằng phong cách thực sự không đến từ việc đắp
                    lên mình thật nhiều thứ, mà là biết cách lược bỏ đi những
                    yếu tố không cần thiết để giữ lại giá trị cốt lõi.
                  </p>
                </div>
              </FadeUpSection>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-16 md:gap-24">
              <div className="w-full md:w-1/2">
                <FadeUpSection>
                  ...
                  <h3 className="text-3xl md:text-4xl font-medium mb-8 leading-tight">
                    Hoàn hảo từ những chi tiết nhỏ nhất.
                  </h3>
                  <div className="space-y-6 text-sm text-aura-gray-dark leading-relaxed">
                    <p>
                      <strong>Chất liệu bền vững:</strong> Tối giản cũng có
                      nghĩa là bảo vệ môi trường. Chúng tôi ưu tiên sử dụng
                      cotton hữu cơ, lụa tự nhiên và linen thoáng mát. Một sản
                      phẩm chất lượng cao có thể thay thế cho 10 sản phẩm kém
                      chất lượng, giúp giảm thiểu đáng kể rác thải thời trang.
                    </p>
                    <p>
                      <strong>Gia công tinh xảo:</strong> Chúng tôi làm việc
                      trực tiếp với những nghệ nhân lành nghề nhất. Thay vì sản
                      xuất hàng loạt, mỗi bộ sưu tập của Aura Studio đều được
                      sản xuất với số lượng giới hạn để đảm bảo sự kiểm tra chất
                      lượng khắt khe nhất trong từng đường kim, mũi chỉ.
                    </p>
                  </div>
                </FadeUpSection>
              </div>
        ...
        <section className="py-24 md:py-32 container mx-auto px-4 md:px-8">
          <FadeUpSection>
            <div className="text-center mb-16">
              <h2 className="text-xs font-bold uppercase tracking-[0.4em] text-aura-gray-dark mb-4">
                Ghé thăm chúng tôi
              </h2>
              <p className="text-3xl font-medium">
                Trải nghiệm không gian Aura
              </p>
            </div>
          </FadeUpSection>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeUpSection delay="delay-100">
              <div className="bg-aura-black text-white p-12 md:p-16 rounded-[2rem] space-y-12">
                <div>
                  <h4 className="text-[10px] font-bold uppercase tracking-widest text-aura-accent mb-3">
                    Địa chỉ Cửa hàng Flagship
                  </h4>
                  <p className="text-lg leading-relaxed">
                    203 Phạm Văn Đồng, Phường 1
                    <br />
                ...
                <div className="border-t border-white/20 pt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-aura-accent mb-2">
                      Điện thoại
                    </h4>
            ...
            <FadeUpSection delay="delay-300">
              <div className="relative aspect-square md:aspect-[4/3] rounded-[2rem] overflow-hidden group bg-aura-gray-medium">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-6 py-4 rounded-full shadow-2xl flex items-center space-x-3 transform group-hover:-translate-y-6 transition-transform duration-500">
                  ...
                  <span className="text-xs font-bold uppercase tracking-widest text-aura-black">
                    Aura Flagship
                  </span>
                </div>
              </div>
